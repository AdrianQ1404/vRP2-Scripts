...
local blips = {
  {name="Hospital", id=621, x= 338.85, y= -1394.56, z= 31.51, color= 1},
  {name="Hospital", id=621, x= -449.67, y= -340.83, z= 33.50, color= 1},
  
    {name="Hospital", id=621, x= 296.64, y= -602.74, z= 43.30, color= 1}, -- west downtown 357.77514648438,-592.25012207031,28.789751052856


  {name="Hospital", id=621, x= 1827.97, y= 3692.58, z= 33.22, color= 1},
  
    {name="Hospital", id=621, x= -239.89, y= 6323.59, z= 31.42, color= 1},
